...
def splicing_csvdata8(list1, list2, list3, list4, list5, list6, list7, list8):
    temp = []
    temp.append(list1)
    # temp = temp + list2
    # temp = temp + list3
...
def splicing_csvdata9(list1, list2, list3, list4, list5, list6, list7, list8, list9):
    temp = []
    temp.append(list1)
    # temp = temp + list2
    # temp = temp + list3
...
def calculate_ylane(img, windwos):
    data = lanelabelmark(img, windwos)
...
def calculate_speedlane(img, windwos):
    data = lanelabelmark(img, windwos)
    if data != ' ':
        datasize = np.array(data[0]).shape[0]
        # print('datasize', datasize)
...
def calculate_stoplane(img, windwos):
    stop = lanelabelmark(img, windwos)
...
#     if len(img.shape) > 2:
#         channel_count = img.shape[0]  # i.e. 3 or 4 depending on your image
